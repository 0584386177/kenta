<div class="flex pt-16 overflow-hidden bg-white max-w-[97%] dark:bg-gray-900 " style="    display: block;
    width: 83%;
    margin-left: 16rem;">
        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <div class="mb-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Đơn hàng</h1>
                </div>
                        ...
                        <table class="w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="p-4 text-xs whitespace-nowrap font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                        ID
                                    </th>
                                    <th scope="col" class="p-4 text-xs whitespace-nowrap font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                        Tên đơn hàng
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">Áo khoác</td>
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-medium text-gray-500 truncate xl:max-w-xs dark:text-gray-400">#SKU001 </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">Huỳnh Khánh Hòa</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">huynhkhanhhoa3006@gmail.com</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">Thành Phố Đà Nẵng</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">0584386177</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">12.490.000d</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">11/1/2004</td>
