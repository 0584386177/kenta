            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="./ForgotPassword" class="text-sm font-medium text-primary-600 hover:text-grey-500 dark:text-primary-500">Quên mật khẩu</a>
                    </div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Chưa có tài khoản ? <a href="./RegisterController" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Đăng ký</a>
                    </p>
                </form>
            </div>
        </div>
