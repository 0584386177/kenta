...
<footer>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <!-- Column 4 -->
            <div>
                <h3 style="font-size: 15px; font-weight:bold;" class="text-base font-bold uppercase mb-4">THÔNG TIN CỬA HÀNG</h3>
                <ul class="space-y-3">
                    <li class="flex">
                        <span class="text-lg mr-2">📍</span>
                        <span class="text-sm text-gray-700">20 Cửu Long, P15, Q10, HCM</span>
                    </li>
                    <li class="flex">
                        <span class="text-lg mr-2">📍</span>
                        <span class="text-sm text-gray-700">168 Nguyễn Trọng Tuyển, P8, Phú Nhuận</span>
                    </li>
                    <li class="flex">
                        <span class="text-lg mr-2">📞</span>
                        <span class="text-sm text-gray-700">Hotline: (028) 7300 6200</span>
                    </li>
                    <li class="flex">
                        <span class="text-lg mr-2">✉️</span>
                        <span class="text-sm text-gray-700">Mail: kentasale@gmail.com</span>
                    </li>
                </ul>
            </div>
        </div>
